...
public class CursomcApplication implements CommandLineRunner { 
	...
	public void run(String... args) throws Exception {   // Executa ao iniciar a aplicação
		...
		ped1.getItens().addAll(Arrays.asList(ip1, ip2));  // Pedido conhece os seus itens
		ped2.getItens().addAll(Arrays.asList(ip3));
		
		p1.getItens().addAll(Arrays.asList(ip1));  // Produto conhece os itens do pedido
